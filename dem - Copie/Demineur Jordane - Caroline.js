...
function traiter() {
	...
	alert("Résultat 1 : " + resultat1 + "\nRésultat 2 : " + resultat2); //pas nécessaire mais est actuellement utilisé pour vérifier si le code est bon 
...
function afficheNb() {
	...
	return "La demande de bombe.s est de: " + input;
}
...
/* test fonction via i++	// Traitement de la nbUser*/
	nbUser=10;
	for(var i=0; i <100; i++){
	nbUser++;
}
